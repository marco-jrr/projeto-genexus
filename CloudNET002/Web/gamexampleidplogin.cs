   ...
   public class gamexampleidplogin : GXHttpHandler
   {
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbforgotpwd_Internalname, "Forgot your password?", "", "", lblTbforgotpwd_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11141_client"+"'", "", "TextBlock", 7, "", lblTbforgotpwd_Visible, 1, 0, 0, "HLP_GAMExampleIDPLogin.htm");
      ...
      protected void E15142( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV31GAMApplication.gxTpr_Clientimageurl)) )
         {
            ...
            AV41Logoappclient_GXI = GXDbFile.PathToUrl( AV31GAMApplication.gxTpr_Clientimageurl, context);
            AssignProp("", false, imgavLogoappclient_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient)) ? AV41Logoappclient_GXI : context.convertURL( context.PathToRelativeUrl( AV20LogoAppClient))), true);
            AssignProp("", false, imgavLogoappclient_Internalname, "SrcSet", context.GetImageSrcSet( AV20LogoAppClient), true);
         }
         else
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617155648", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleidplogin.js", "?202442617155651", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD","""{"handler":"E17142","iparms":[{"av":"divTblexternalsauth_Visible","ctrl":"TBLEXTERNALSAUTH","prop":"Visible"}]""");
         setEventMetadata("GRIDAUTHTYPES.LOAD",""","oparms":[{"av":"AV36NameAuthType","fld":"vNAMEAUTHTYPE","hsh":true},{"ctrl":"EXTERNALAUTHENTICATION","prop":"Caption"},{"ctrl":"EXTERNALAUTHENTICATION","prop":"Tooltiptext"},{"av":"divTblexternalsauth_Visible","ctrl":"TBLEXTERNALSAUTH","prop":"Visible"}]}""");
         setEventMetadata("VLOGONTO.CLICK","""{"handler":"E12142","iparms":[{"av":"AV18Language","fld":"vLANGUAGE","hsh":true},{"av":"cmbavLogonto"},{"av":"AV21LogOnTo","fld":"vLOGONTO"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E13142","iparms":[{"av":"AV17KeepMeLoggedIn","fld":"vKEEPMELOGGEDIN"},{"av":"AV22RememberMe","fld":"vREMEMBERME"},{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"cmbavLogonto"},{"av":"AV21LogOnTo","fld":"vLOGONTO"},{"av":"AV28UserName","fld":"vUSERNAME"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]}""");
         setEventMetadata("'FORGOTPASSWORD'","""{"handler":"E11141","iparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"}]""");
         setEventMetadata("'FORGOTPASSWORD'",""","oparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"}]}""");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","""{"handler":"E14142","iparms":[{"av":"AV17KeepMeLoggedIn","fld":"vKEEPMELOGGEDIN"},{"av":"AV22RememberMe","fld":"vREMEMBERME"},{"av":"AV36NameAuthType","fld":"vNAMEAUTHTYPE","hsh":true},{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"AV28UserName","fld":"vUSERNAME"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]}""");
