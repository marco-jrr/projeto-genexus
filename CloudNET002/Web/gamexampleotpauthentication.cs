...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler
   {
      ...
      protected void E11102( )
      {
         /* Start Routine */
         returnInSub = false;
         AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertootpauthentication(out  AV7AuthenticationTypeName, out  AV16UseTwoFactorAuthentication, out  AV9GAMErrorCollection);
         ...
         {
            AV17GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypebyname(AV7AuthenticationTypeName, AV18Language, out  AV9GAMErrorCollection);
            if ( ! AV17GAMAuthenticationTypeSimple.gxTpr_Istotp && ! AV17GAMAuthenticationTypeSimple.gxTpr_Twofactorauthentication_istotp )
            {
      ...
      protected void E12102( )
      {
         ...
         if ( AV9GAMErrorCollection.Count == 0 )
         {
            ...
            AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV14UserName, AV15UserPassword, AV6AdditionalParameter, out  AV9GAMErrorCollection);
            if ( AV11LoginOK )
            {
            ...
            else
            {
               if ( AV9GAMErrorCollection.Count > 0 )
               {
                  if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9GAMErrorCollection.Item(1)).gxTpr_Code == 161 )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV19GXV1 = 1;
         while ( AV19GXV1 <= AV9GAMErrorCollection.Count )
         {
            AV8GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9GAMErrorCollection.Item(AV19GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617151254", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?202442617151257", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12102","iparms":[{"av":"AV7AuthenticationTypeName","fld":"vAUTHENTICATIONTYPENAME","hsh":true},{"av":"AV16UseTwoFactorAuthentication","fld":"vUSETWOFACTORAUTHENTICATION","hsh":true},{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV14UserName","fld":"vUSERNAME","hsh":true},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]}""");
         setEventMetadata("'LOGIN'","""{"handler":"E13102","iparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV17GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple(context);
         AV18Language = "";
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple AV17GAMAuthenticationTypeSimple ;
