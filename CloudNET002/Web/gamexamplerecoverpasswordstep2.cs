...
namespace GeneXus.Programs {
   public class gamexamplerecoverpasswordstep2 : GXHttpHandler
   {
      ...
      protected void E11132( )
      {
         ...
         {
            AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV14UserAuthTypeName, AV15UserName, out  AV8GAMErrorCollection);
            if ( AV8GAMErrorCollection.Count == 0 )
            {
               AV6ChangePwdOK = AV13User.changepasswordbykey(AV10KeyToChangePassword, AV16UserPasswordNew, out  AV8GAMErrorCollection);
               if ( AV6ChangePwdOK )
               {
                  ...
                  AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV15UserName, AV16UserPasswordNew, AV5AdditionalParameter, out  AV8GAMErrorCollection);
                  if ( AV11LoginOK )
                  {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV19GXV1 = 1;
         while ( AV19GXV1 <= AV8GAMErrorCollection.Count )
         {
            AV7GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV8GAMErrorCollection.Item(AV19GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20244261715463", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplerecoverpasswordstep2.js", "?20244261715466", false, true);
