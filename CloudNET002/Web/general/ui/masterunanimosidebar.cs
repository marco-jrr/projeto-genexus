...
namespace GeneXus.Programs.general.ui {
   public class masterunanimosidebar : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?202442617141529", false, true);
      ...
      protected void E11012( )
      {
         /* Start Routine */
         returnInSub = false;
         if ( ( NumberUtil.Val( AV7WebSession.Get("EmpresaId"), ".") == Convert.ToDecimal( 0 )) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202442617141541", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("general/ui/masterunanimosidebar.js", "?202442617141541", false, true);
         context.AddJavascriptSource("Unanimo_chameleon/chameleon.js", "", false, true);
         context.AddJavascriptSource("UserControls/GeneXusUnanimo.SidebarRender.js", "", false, true);
