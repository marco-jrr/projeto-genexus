...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTRegistroPedido( )
      {
         string cmdBuffer = "";
         /* Indices for table TRegistroPedido */
         cmdBuffer=" ALTER TABLE [TRegistroPedido] ADD [DataRetirada] datetime NOT NULL CONSTRAINT DataRetiradaTRegistroPedido_DEFAULT DEFAULT convert( DATETIME, '17530101', 112 ), [DataRetorno] datetime NULL  "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [TRegistroPedido] DROP CONSTRAINT DataRetiradaTRegistroPedido_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [TRegistroPedido] DROP COLUMN [DataHoraRetirada], [DataHoraRetorno] "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            TRegistroPedidoCount = P00012_ATRegistroPedidoCount[0];
            pr_default.close(0);
            PrintRecordCount ( "TRegistroPedido" ,  TRegistroPedidoCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("TRegistroPedido",sSchemaVar,"DataRetirada") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DataRetirada", "TRegistroPedido"}) ) ;
            return false ;
         }
         if ( ColumnExist("TRegistroPedido",sSchemaVar,"DataRetorno") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DataRetorno", "TRegistroPedido"}) ) ;
            return false ;
         }
         if ( ! ColumnExist("TRegistroPedido",sSchemaVar,"DataHoraRetirada") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"DataHoraRetirada", "TRegistroPedido"}) ) ;
            return false ;
         }
         if ( ! ColumnExist("TRegistroPedido",sSchemaVar,"DataHoraRetorno") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"DataHoraRetorno", "TRegistroPedido"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeTRegistroPedido" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"TRegistroPedido", ""}) );
      }
      ...
      {
         P00012_ATRegistroPedidoCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int TRegistroPedidoCount ;
      ...
      protected int[] P00012_ATRegistroPedidoCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [TRegistroPedido] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
