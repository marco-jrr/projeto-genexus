...
namespace GeneXus.Programs {
   public class tclientetregistropedidowc : GXWebComponent
   {
      public tclientetregistropedidowc( )
      {
      ...
      public tclientetregistropedidowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7ClienteId = (long)(Math.Round(NumberUtil.Val( GetPar( "ClienteId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV7ClienteId", StringUtil.LTrimStr( (decimal)(AV7ClienteId), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6EmpresaId,(long)AV7ClienteId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6EmpresaId, AV7ClienteId, AV13Update, AV14Delete, A1EmpresaId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "TClienteTRegistroPedidoWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "TCliente TRegistro Pedido WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tclientetregistropedidowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(AV7ClienteId,12,0))}, new string[] {"EmpresaId","ClienteId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"TClienteTRegistroPedidoWC");
         forbiddenHiddens.Add("EmpresaId", context.localUtil.Format( (decimal)(A1EmpresaId), "ZZZZZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("tclientetregistropedidowc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7ClienteId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV7ClienteId), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vEMPRESAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EmpresaId), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7ClienteId), 12, 0, ".", "")));
      ...
      {
         return "TClienteTRegistroPedidoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "TCliente TRegistro Pedido WC" ;
      }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tclientetregistropedidowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TClienteTRegistroPedidoWC.htm");
      ...
      protected void START0U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "TCliente TRegistro Pedido WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF0U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000U2 */
            pr_default.execute(0, new Object[] {AV6EmpresaId, AV7ClienteId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1EmpresaId = H000U2_A1EmpresaId[0];
               AssignAttri(sPrefix, false, "A1EmpresaId", StringUtil.LTrimStr( (decimal)(A1EmpresaId), 12, 0));
               A5ClienteId = H000U2_A5ClienteId[0];
               AssignAttri(sPrefix, false, "A5ClienteId", StringUtil.LTrimStr( (decimal)(A5ClienteId), 12, 0));
               A11VeiculoMarca = H000U2_A11VeiculoMarca[0];
               A25DataRetorno = H000U2_A25DataRetorno[0];
               n25DataRetorno = H000U2_n25DataRetorno[0];
               A24DataRetirada = H000U2_A24DataRetirada[0];
               A17Destino = H000U2_A17Destino[0];
               A10VeiculoId = H000U2_A10VeiculoId[0];
               A16RegistroPedidoId = H000U2_A16RegistroPedidoId[0];
               A11VeiculoMarca = H000U2_A11VeiculoMarca[0];
               /* Execute user event: Grid.Load */
               E130U2 ();
      ...
      {
         /* Using cursor H000U3 */
         pr_default.execute(1, new Object[] {AV6EmpresaId, AV7ClienteId});
      ...
      protected void STRUP0U0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7ClienteId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7ClienteId"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("tclientetregistropedidowc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         AV12TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV12TrnContextAtt.gxTpr_Attributename = "ClienteId";
         AV12TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV7ClienteId), 12, 0);
         AV11TrnContext.gxTpr_Attributes.Add(AV12TrnContextAtt, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV6EmpresaId", StringUtil.LTrimStr( (decimal)(AV6EmpresaId), 12, 0));
         AV7ClienteId = Convert.ToInt64(getParm(obj,1));
         AssignAttri(sPrefix, false, "AV7ClienteId", StringUtil.LTrimStr( (decimal)(AV7ClienteId), 12, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tclientetregistropedidowc", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV6EmpresaId", StringUtil.LTrimStr( (decimal)(AV6EmpresaId), 12, 0));
            AV7ClienteId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV7ClienteId", StringUtil.LTrimStr( (decimal)(AV7ClienteId), 12, 0));
         }
         wcpOAV6EmpresaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EmpresaId"), ".", ","), 18, MidpointRounding.ToEven));
         wcpOAV7ClienteId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7ClienteId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV6EmpresaId != wcpOAV6EmpresaId ) || ( AV7ClienteId != wcpOAV7ClienteId ) ) )
         {
            setjustcreated();
         }
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV7ClienteId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV7ClienteId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV7ClienteId", StringUtil.LTrimStr( (decimal)(AV7ClienteId), 12, 0));
         }
         else
         {
            AV7ClienteId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV7ClienteId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7ClienteId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7ClienteId), 12, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20244261714795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tclientetregistropedidowc.js", "?20244261714795", false, true);
         }
      ...
      protected void StartGridControl22( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Veiculo Marca") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"AV7ClienteId","fld":"vCLIENTEID","pic":"ZZZZZZZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"},{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130U2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A16RegistroPedidoId","fld":"REGISTROPEDIDOID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A10VeiculoId","fld":"VEICULOID","pic":"ZZZZZZZZZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtDestino_Link","ctrl":"DESTINO","prop":"Link"},{"av":"edtVeiculoMarca_Link","ctrl":"VEICULOMARCA","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110U2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A16RegistroPedidoId","fld":"REGISTROPEDIDOID","pic":"ZZZZZZZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"AV7ClienteId","fld":"vCLIENTEID","pic":"ZZZZZZZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A11VeiculoMarca = "";
         H000U2_A1EmpresaId = new long[1] ;
         H000U2_A5ClienteId = new long[1] ;
         H000U2_A11VeiculoMarca = new string[] {""} ;
         H000U2_A25DataRetorno = new DateTime[] {DateTime.MinValue} ;
         H000U2_n25DataRetorno = new bool[] {false} ;
         H000U2_A24DataRetirada = new DateTime[] {DateTime.MinValue} ;
         H000U2_A17Destino = new string[] {""} ;
         H000U2_A10VeiculoId = new long[1] ;
         H000U2_A16RegistroPedidoId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tclientetregistropedidowc__default(),
            new Object[][] {
                new Object[] {
               H000U2_A1EmpresaId, H000U2_A5ClienteId, H000U2_A11VeiculoMarca, H000U2_A25DataRetorno, H000U2_n25DataRetorno, H000U2_A24DataRetirada, H000U2_A17Destino, H000U2_A10VeiculoId, H000U2_A16RegistroPedidoId
               }
               , new Object[] {
      ...
      private long[] H000U2_A1EmpresaId ;
      private long[] H000U2_A5ClienteId ;
      private string[] H000U2_A11VeiculoMarca ;
      private DateTime[] H000U2_A25DataRetorno ;
      private bool[] H000U2_n25DataRetorno ;
      private DateTime[] H000U2_A24DataRetirada ;
      private string[] H000U2_A17Destino ;
      private long[] H000U2_A10VeiculoId ;
      private long[] H000U2_A16RegistroPedidoId ;
   ...
   public class tclientetregistropedidowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7ClienteId",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000U2", "SELECT T1.[EmpresaId], T1.[ClienteId], T2.[VeiculoMarca], T1.[DataRetorno], T1.[DataRetirada], T1.[Destino], T1.[VeiculoId], T1.[RegistroPedidoId] FROM ([TRegistroPedido] T1 INNER JOIN [TVeiculo] T2 ON T2.[EmpresaId] = T1.[EmpresaId] AND T2.[VeiculoId] = T1.[VeiculoId]) WHERE T1.[EmpresaId] = @AV6EmpresaId and T1.[ClienteId] = @AV7ClienteId ORDER BY T1.[EmpresaId], T1.[ClienteId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000U3", "SELECT COUNT(*) FROM ([TRegistroPedido] T1 INNER JOIN [TVeiculo] T2 ON T2.[EmpresaId] = T1.[EmpresaId] AND T2.[VeiculoId] = T1.[VeiculoId]) WHERE T1.[EmpresaId] = @AV6EmpresaId and T1.[ClienteId] = @AV7ClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
