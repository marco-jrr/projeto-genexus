...
namespace GeneXus.Programs {
   public class tempresageneral : GXWebComponent
   {
      public tempresageneral( )
      {
      ...
      public tempresageneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)A1EmpresaId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "TEmpresa General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tempresageneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1EmpresaId,12,0))}, new string[] {"EmpresaId"}) +"\">") ;
      ...
      {
         return "TEmpresaGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "TEmpresa General" ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tempresageneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110d1_client"+"'", TempTags, "", 2, "HLP_TEmpresaGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120d1_client"+"'", TempTags, "", 2, "HLP_TEmpresaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEmpresaNome_Internalname, "Nome", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEmpresaNome_Internalname, A2EmpresaNome, StringUtil.RTrim( context.localUtil.Format( A2EmpresaNome, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmpresaNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEmpresaNome_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_TEmpresaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEmpresaEmail_Internalname, "Email", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEmpresaEmail_Internalname, A3EmpresaEmail, StringUtil.RTrim( context.localUtil.Format( A3EmpresaEmail, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A3EmpresaEmail, "", "", "", edtEmpresaEmail_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEmpresaEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "start", true, "", "HLP_TEmpresaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEmpresaEndereco_Internalname, "Endereco", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtEmpresaEndereco_Internalname, A4EmpresaEndereco, "http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4EmpresaEndereco), "", 0, 1, edtEmpresaEndereco_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "1024", -1, 0, "_blank", "", 0, true, "GeneXus\\Address", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_TEmpresaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0D2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "TEmpresa General", 0) ;
            context.wjLoc = "";
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4EmpresaEndereco = H000D2_A4EmpresaEndereco[0];
               AssignAttri(sPrefix, false, "A4EmpresaEndereco", A4EmpresaEndereco);
               A3EmpresaEmail = H000D2_A3EmpresaEmail[0];
               AssignAttri(sPrefix, false, "A3EmpresaEmail", A3EmpresaEmail);
               A2EmpresaNome = H000D2_A2EmpresaNome[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtEmpresaEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmpresaEmail_Enabled), 5, 0), true);
         edtEmpresaEndereco_Enabled = 0;
         AssignProp(sPrefix, false, edtEmpresaEndereco_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmpresaEndereco_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "TEmpresa";
         AV8TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "EmpresaId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6EmpresaId), 12, 0);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tempresageneral", GetJustCreated( ));
         ...
         wcpOA1EmpresaId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1EmpresaId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A1EmpresaId != wcpOA1EmpresaId ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617135848", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("tempresageneral.js", "?202442617135848", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtEmpresaEndereco_Internalname = sPrefix+"EMPRESAENDERECO";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E110D1","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E120D1","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]}""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H000D2_A1EmpresaId = new long[1] ;
         H000D2_A4EmpresaEndereco = new string[] {""} ;
         H000D2_A3EmpresaEmail = new string[] {""} ;
         H000D2_A2EmpresaNome = new string[] {""} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         sCtrlA1EmpresaId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tempresageneral__default(),
            new Object[][] {
                new Object[] {
               H000D2_A1EmpresaId, H000D2_A4EmpresaEndereco, H000D2_A3EmpresaEmail, H000D2_A2EmpresaNome
               }
            }
         );
         AV11Pgmname = "TEmpresaGeneral";
      ...
      private long[] H000D2_A1EmpresaId ;
      private string[] H000D2_A4EmpresaEndereco ;
      private string[] H000D2_A3EmpresaEmail ;
      private string[] H000D2_A2EmpresaNome ;
   ...
   public class tempresageneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [EmpresaId], [EmpresaEndereco], [EmpresaEmail], [EmpresaNome] FROM [TEmpresa] WHERE [EmpresaId] = @EmpresaId ORDER BY [EmpresaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
