...
namespace GeneXus.Programs {
   public class tempresatclientewc : GXWebComponent
   {
      public tempresatclientewc( )
      {
      ...
      public tempresatclientewc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "TEmpresaTClienteWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "TEmpresa TCliente WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tempresatclientewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0))}, new string[] {"EmpresaId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"TEmpresaTClienteWC");
         forbiddenHiddens.Add("EmpresaId", context.localUtil.Format( (decimal)(A1EmpresaId), "ZZZZZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("tempresatclientewc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "TEmpresaTClienteWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "TEmpresa TCliente WC" ;
      }
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tempresatclientewc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TEmpresaTClienteWC.htm");
      ...
      protected void START0E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "TEmpresa TCliente WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLIENTEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A5ClienteId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5ClienteId), 12, 0, ".", "")));
      }
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpresaId = H000E2_A1EmpresaId[0];
               AssignAttri(sPrefix, false, "A1EmpresaId", StringUtil.LTrimStr( (decimal)(A1EmpresaId), 12, 0));
               A9ClienteTelefone = H000E2_A9ClienteTelefone[0];
               A8ClienteEmail = H000E2_A8ClienteEmail[0];
               A7ClienteCPF = H000E2_A7ClienteCPF[0];
               A6ClienteNome = H000E2_A6ClienteNome[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLIENTEID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A5ClienteId), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtClienteNome_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtClienteNome_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtClienteCPF_Enabled = 0;
         AssignProp(sPrefix, false, edtClienteCPF_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtClienteCPF_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtClienteEmail_Enabled = 0;
         AssignProp(sPrefix, false, edtClienteEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtClienteEmail_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtClienteTelefone_Enabled = 0;
         AssignProp(sPrefix, false, edtClienteTelefone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtClienteTelefone_Enabled), 5, 0), !bGXsfl_22_Refreshing);
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLogError("tempresatclientewc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      private void E130E2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tcliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A5ClienteId,12,0))}, new string[] {"Mode","EmpresaId","ClienteId"}) ;
         edtavDelete_Link = formatLink("tcliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A5ClienteId,12,0))}, new string[] {"Mode","EmpresaId","ClienteId"}) ;
      ...
      protected void E110E2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("tcliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","EmpresaId","ClienteId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "TCliente";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tempresatclientewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617135876", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tempresatclientewc.js", "?202442617135877", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtClienteNome_Internalname = sPrefix+"CLIENTENOME_"+sGXsfl_22_idx;
         edtClienteCPF_Internalname = sPrefix+"CLIENTECPF_"+sGXsfl_22_idx;
         edtClienteEmail_Internalname = sPrefix+"CLIENTEEMAIL_"+sGXsfl_22_idx;
         edtClienteTelefone_Internalname = sPrefix+"CLIENTETELEFONE_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtClienteNome_Internalname = sPrefix+"CLIENTENOME_"+sGXsfl_22_fel_idx;
         edtClienteCPF_Internalname = sPrefix+"CLIENTECPF_"+sGXsfl_22_fel_idx;
         edtClienteEmail_Internalname = sPrefix+"CLIENTEEMAIL_"+sGXsfl_22_fel_idx;
         edtClienteTelefone_Internalname = sPrefix+"CLIENTETELEFONE_"+sGXsfl_22_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130E2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A5ClienteId","fld":"CLIENTEID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtClienteNome_Link","ctrl":"CLIENTENOME","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110E2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A5ClienteId","fld":"CLIENTEID","pic":"ZZZZZZZZZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         A8ClienteEmail = "";
         A9ClienteTelefone = "";
         H000E2_A1EmpresaId = new long[1] ;
         H000E2_A9ClienteTelefone = new string[] {""} ;
         H000E2_A8ClienteEmail = new string[] {""} ;
         H000E2_A7ClienteCPF = new long[1] ;
         H000E2_A6ClienteNome = new string[] {""} ;
         H000E2_A5ClienteId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tempresatclientewc__default(),
            new Object[][] {
                new Object[] {
               H000E2_A1EmpresaId, H000E2_A9ClienteTelefone, H000E2_A8ClienteEmail, H000E2_A7ClienteCPF, H000E2_A6ClienteNome, H000E2_A5ClienteId
               }
               , new Object[] {
      ...
      private long[] H000E2_A1EmpresaId ;
      private string[] H000E2_A9ClienteTelefone ;
      private string[] H000E2_A8ClienteEmail ;
      private long[] H000E2_A7ClienteCPF ;
      private string[] H000E2_A6ClienteNome ;
      private long[] H000E2_A5ClienteId ;
   ...
   public class tempresatclientewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000E2", "SELECT [EmpresaId], [ClienteTelefone], [ClienteEmail], [ClienteCPF], [ClienteNome], [ClienteId] FROM [TCliente] WHERE [EmpresaId] = @AV6EmpresaId ORDER BY [EmpresaId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000E3", "SELECT COUNT(*) FROM [TCliente] WHERE [EmpresaId] = @AV6EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
