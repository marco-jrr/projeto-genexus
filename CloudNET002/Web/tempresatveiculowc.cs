...
namespace GeneXus.Programs {
   public class tempresatveiculowc : GXWebComponent
   {
      public tempresatveiculowc( )
      {
      ...
      public tempresatveiculowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "TEmpresaTVeiculoWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "TEmpresa TVeiculo WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tempresatveiculowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0))}, new string[] {"EmpresaId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"TEmpresaTVeiculoWC");
         forbiddenHiddens.Add("EmpresaId", context.localUtil.Format( (decimal)(A1EmpresaId), "ZZZZZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("tempresatveiculowc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "TEmpresaTVeiculoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "TEmpresa TVeiculo WC" ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tempresatveiculowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TEmpresaTVeiculoWC.htm");
      ...
      protected void START0F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "TEmpresa TVeiculo WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VEICULOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A10VeiculoId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"VEICULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10VeiculoId), 12, 0, ".", "")));
      }
      ...
      protected void RF0F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpresaId = H000F2_A1EmpresaId[0];
               AssignAttri(sPrefix, false, "A1EmpresaId", StringUtil.LTrimStr( (decimal)(A1EmpresaId), 12, 0));
               A15VeiculoAno = H000F2_A15VeiculoAno[0];
               A14VeiculoCor = H000F2_A14VeiculoCor[0];
               A13VeiculoPlaca = H000F2_A13VeiculoPlaca[0];
               A12VeiculoModelo = H000F2_A12VeiculoModelo[0];
               A11VeiculoMarca = H000F2_A11VeiculoMarca[0];
               A10VeiculoId = H000F2_A10VeiculoId[0];
               /* Execute user event: Grid.Load */
               E130F2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VEICULOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A10VeiculoId), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtVeiculoId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoId_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtVeiculoMarca_Enabled = 0;
         AssignProp(sPrefix, false, edtVeiculoMarca_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoMarca_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtVeiculoModelo_Enabled = 0;
         AssignProp(sPrefix, false, edtVeiculoModelo_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoModelo_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtVeiculoPlaca_Enabled = 0;
         AssignProp(sPrefix, false, edtVeiculoPlaca_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoPlaca_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtVeiculoCor_Enabled = 0;
         AssignProp(sPrefix, false, edtVeiculoCor_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoCor_Enabled), 5, 0), !bGXsfl_22_Refreshing);
         edtVeiculoAno_Enabled = 0;
         AssignProp(sPrefix, false, edtVeiculoAno_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtVeiculoAno_Enabled), 5, 0), !bGXsfl_22_Refreshing);
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLogError("tempresatveiculowc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      private void E130F2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tveiculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A10VeiculoId,12,0))}, new string[] {"Mode","EmpresaId","VeiculoId"}) ;
         edtavDelete_Link = formatLink("tveiculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A10VeiculoId,12,0))}, new string[] {"Mode","EmpresaId","VeiculoId"}) ;
      ...
      protected void E110F2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("tveiculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(AV6EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","EmpresaId","VeiculoId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "TVeiculo";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tempresatveiculowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20244261714779", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tempresatveiculowc.js", "?20244261714779", false, true);
         }
      ...
      {
         edtVeiculoId_Internalname = sPrefix+"VEICULOID_"+sGXsfl_22_idx;
         edtVeiculoMarca_Internalname = sPrefix+"VEICULOMARCA_"+sGXsfl_22_idx;
         edtVeiculoModelo_Internalname = sPrefix+"VEICULOMODELO_"+sGXsfl_22_idx;
         edtVeiculoPlaca_Internalname = sPrefix+"VEICULOPLACA_"+sGXsfl_22_idx;
         edtVeiculoCor_Internalname = sPrefix+"VEICULOCOR_"+sGXsfl_22_idx;
         edtVeiculoAno_Internalname = sPrefix+"VEICULOANO_"+sGXsfl_22_idx;
      ...
      {
         edtVeiculoId_Internalname = sPrefix+"VEICULOID_"+sGXsfl_22_fel_idx;
         edtVeiculoMarca_Internalname = sPrefix+"VEICULOMARCA_"+sGXsfl_22_fel_idx;
         edtVeiculoModelo_Internalname = sPrefix+"VEICULOMODELO_"+sGXsfl_22_fel_idx;
         edtVeiculoPlaca_Internalname = sPrefix+"VEICULOPLACA_"+sGXsfl_22_fel_idx;
         edtVeiculoCor_Internalname = sPrefix+"VEICULOCOR_"+sGXsfl_22_fel_idx;
         edtVeiculoAno_Internalname = sPrefix+"VEICULOANO_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVeiculoModelo_Internalname,(string)A12VeiculoModelo,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVeiculoModelo_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVeiculoPlaca_Internalname,StringUtil.RTrim( A13VeiculoPlaca),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVeiculoPlaca_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)7,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVeiculoCor_Internalname,StringUtil.RTrim( A14VeiculoCor),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVeiculoCor_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVeiculoAno_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A15VeiculoAno), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A15VeiculoAno), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVeiculoAno_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130F2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A10VeiculoId","fld":"VEICULOID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtVeiculoMarca_Link","ctrl":"VEICULOMARCA","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110F2","iparms":[{"av":"AV6EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A10VeiculoId","fld":"VEICULOID","pic":"ZZZZZZZZZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         A13VeiculoPlaca = "";
         A14VeiculoCor = "";
         H000F2_A1EmpresaId = new long[1] ;
         H000F2_A15VeiculoAno = new short[1] ;
         H000F2_A14VeiculoCor = new string[] {""} ;
         H000F2_A13VeiculoPlaca = new string[] {""} ;
         H000F2_A12VeiculoModelo = new string[] {""} ;
         H000F2_A11VeiculoMarca = new string[] {""} ;
         H000F2_A10VeiculoId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tempresatveiculowc__default(),
            new Object[][] {
                new Object[] {
               H000F2_A1EmpresaId, H000F2_A15VeiculoAno, H000F2_A14VeiculoCor, H000F2_A13VeiculoPlaca, H000F2_A12VeiculoModelo, H000F2_A11VeiculoMarca, H000F2_A10VeiculoId
               }
               , new Object[] {
      ...
      private long[] H000F2_A1EmpresaId ;
      private short[] H000F2_A15VeiculoAno ;
      private string[] H000F2_A14VeiculoCor ;
      private string[] H000F2_A13VeiculoPlaca ;
      private string[] H000F2_A12VeiculoModelo ;
      private string[] H000F2_A11VeiculoMarca ;
      private long[] H000F2_A10VeiculoId ;
   ...
   public class tempresatveiculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT [EmpresaId], [VeiculoAno], [VeiculoCor], [VeiculoPlaca], [VeiculoModelo], [VeiculoMarca], [VeiculoId] FROM [TVeiculo] WHERE [EmpresaId] = @AV6EmpresaId ORDER BY [EmpresaId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000F3", "SELECT COUNT(*) FROM [TVeiculo] WHERE [EmpresaId] = @AV6EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
