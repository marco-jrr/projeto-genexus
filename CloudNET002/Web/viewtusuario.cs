...
namespace GeneXus.Programs {
   public class viewtusuario : GXDataArea
   {
      public viewtusuario( )
      {
      ...
      public viewtusuario( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV13UsuarioId = (long)(Math.Round(NumberUtil.Val( GetPar( "UsuarioId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "AV13UsuarioId", StringUtil.LTrimStr( (decimal)(AV13UsuarioId), 12, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13UsuarioId), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewtusuario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(AV13UsuarioId,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmpresaId","UsuarioId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPRESAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpresaId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13UsuarioId), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13UsuarioId), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewTUsuario");
         forbiddenHiddens.Add("UsuarioNome", StringUtil.RTrim( context.localUtil.Format( A21UsuarioNome, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewtusuario:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewtusuario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(AV13UsuarioId,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmpresaId","UsuarioId","TabCode"})  ;
      }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Usuários", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewTUsuario.htm");
            ...
            GxWebStd.gx_label_element( context, edtUsuarioNome_Internalname, "Nome", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtUsuarioNome_Internalname, A21UsuarioNome, StringUtil.RTrim( context.localUtil.Format( A21UsuarioNome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuarioNome_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtUsuarioNome_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewTUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewTUsuario.htm");
            /* Div Control */
      ...
      protected void START0H2( )
      {
         ...
         Form.Meta.addItem("description", "View TUsuario", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0H2( )
      {
         ...
         {
            /* Using cursor H000H2 */
            pr_default.execute(0, new Object[] {AV12EmpresaId, AV13UsuarioId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A20UsuarioId = H000H2_A20UsuarioId[0];
               A1EmpresaId = H000H2_A1EmpresaId[0];
               A21UsuarioNome = H000H2_A21UsuarioNome[0];
      ...
      protected void STRUP0H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13UsuarioId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vUSUARIOID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewtusuario:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110H2( )
      {
         ...
         AV15GXLvl7 = 0;
         /* Using cursor H000H3 */
         pr_default.execute(1, new Object[] {AV12EmpresaId, AV13UsuarioId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A20UsuarioId = H000H3_A20UsuarioId[0];
            A1EmpresaId = H000H3_A1EmpresaId[0];
            A21UsuarioNome = H000H3_A21UsuarioNome[0];
            AssignAttri("", false, "A21UsuarioNome", A21UsuarioNome);
            AV15GXLvl7 = 1;
            Form.Caption = A21UsuarioNome;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwtusuario.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "TUsuarioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "tusuariogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "TUsuarioGeneral";
               WebComp_Generalwc_Component = "TUsuarioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(long)AV12EmpresaId,(long)AV13UsuarioId});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV12EmpresaId", StringUtil.LTrimStr( (decimal)(AV12EmpresaId), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPRESAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpresaId), "ZZZZZZZZZZZ9"), context));
         AV13UsuarioId = Convert.ToInt64(getParm(obj,1));
         AssignAttri("", false, "AV13UsuarioId", StringUtil.LTrimStr( (decimal)(AV13UsuarioId), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13UsuarioId), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617141582", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtusuario.js", "?202442617141582", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12EmpresaId","fld":"vEMPRESAID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV13UsuarioId","fld":"vUSUARIOID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A21UsuarioNome","fld":"USUARIONOME"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV14Pgmname = "";
         H000H2_A20UsuarioId = new long[1] ;
         H000H2_A1EmpresaId = new long[1] ;
         H000H2_A21UsuarioNome = new string[] {""} ;
         hsh = "";
         H000H3_A20UsuarioId = new long[1] ;
         H000H3_A1EmpresaId = new long[1] ;
         H000H3_A21UsuarioNome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtusuario__default(),
            new Object[][] {
                new Object[] {
               H000H2_A20UsuarioId, H000H2_A1EmpresaId, H000H2_A21UsuarioNome
               }
               , new Object[] {
               H000H3_A20UsuarioId, H000H3_A1EmpresaId, H000H3_A21UsuarioNome
               }
            }
         );
      ...
      private long wcpOAV13UsuarioId ;
      ...
      private long[] H000H2_A20UsuarioId ;
      private long[] H000H2_A1EmpresaId ;
      private string[] H000H2_A21UsuarioNome ;
      private long[] H000H3_A20UsuarioId ;
      private long[] H000H3_A1EmpresaId ;
      private string[] H000H3_A21UsuarioNome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewtusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV13UsuarioId",GXType.Decimal,12,0)
          };
          Object[] prmH000H3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT [UsuarioId], [EmpresaId], [UsuarioNome] FROM [TUsuario] WHERE [EmpresaId] = @AV12EmpresaId and [UsuarioId] = @AV13UsuarioId ORDER BY [EmpresaId], [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000H3", "SELECT [UsuarioId], [EmpresaId], [UsuarioNome] FROM [TUsuario] WHERE ([EmpresaId] = @AV12EmpresaId and [UsuarioId] = @AV13UsuarioId) AND ([EmpresaId] = @AV12EmpresaId and [UsuarioId] = @AV13UsuarioId) ORDER BY [EmpresaId], [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
