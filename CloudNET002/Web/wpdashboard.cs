...
namespace GeneXus.Programs {
   public class wpdashboard : GXWebComponent
   {
      public wpdashboard( )
      {
      ...
      public wpdashboard( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WPDashboard") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpdashboard.aspx") +"\">") ;
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpdashboard.aspx");
               context.AddJavascriptSource("DashboardViewer/../QueryViewer/QueryViewerRender.js", "", false, true);
               context.AddJavascriptSource("DashboardViewer/../QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("DashboardViewer/BrowserLayoutRender.js", "", false, true);
               context.AddJavascriptSource("DashboardViewer/DashboardViewerRender.js", "", false, true);
      ...
      protected void START192( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WPDashboard", 0) ;
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpdashboard", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617135878", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wpdashboard.js", "?202442617135878", false, true);
            context.AddJavascriptSource("DashboardViewer/../QueryViewer/QueryViewerRender.js", "", false, true);
            context.AddJavascriptSource("DashboardViewer/../QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("DashboardViewer/BrowserLayoutRender.js", "", false, true);
            context.AddJavascriptSource("DashboardViewer/DashboardViewerRender.js", "", false, true);
