...
namespace GeneXus.Programs {
   public class wwtempresa : GXDataArea
   {
      public wwtempresa( )
      {
      ...
      public wwtempresa( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11EmpresaNome = GetPar( "EmpresaNome");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11EmpresaNome, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwtempresa.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEMPRESANOME", AV11EmpresaNome);
         /* Send saved values. */
      ...
      {
         return formatLink("wwtempresa.aspx")  ;
      }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Empresas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWTEmpresa.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWTEmpresa.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavEmpresanome_Internalname, "Empresa Nome", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmpresanome_Internalname, AV11EmpresaNome, StringUtil.RTrim( context.localUtil.Format( AV11EmpresaNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nome", edtavEmpresanome_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavEmpresanome_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWTEmpresa.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0C2( )
      {
         ...
         Form.Meta.addItem("description", "Work With Empresas", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Empresanome Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vEMPRESANOME"), AV11EmpresaNome) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0C2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavEmpresanome_Internalname;
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11EmpresaNome = StringUtil.Concat( StringUtil.RTrim( AV11EmpresaNome), "%", "");
            /* Using cursor H000C2 */
            pr_default.execute(0, new Object[] {lV11EmpresaNome, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A4EmpresaEndereco = H000C2_A4EmpresaEndereco[0];
               A3EmpresaEmail = H000C2_A3EmpresaEmail[0];
               A2EmpresaNome = H000C2_A2EmpresaNome[0];
               A1EmpresaId = H000C2_A1EmpresaId[0];
               /* Execute user event: Grid.Load */
               E140C2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_EMPRESAID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A1EmpresaId), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11EmpresaNome = StringUtil.Concat( StringUtil.RTrim( AV11EmpresaNome), "%", "");
         /* Using cursor H000C3 */
         pr_default.execute(1, new Object[] {lV11EmpresaNome});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11EmpresaNome = GridState.FilterValues("Empresanome");
            AssignAttri("", false, "AV11EmpresaNome", AV11EmpresaNome);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("EmpresaNome", AV11EmpresaNome);
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtEmpresaEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmpresaEmail_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         edtEmpresaEndereco_Enabled = 0;
         AssignProp("", false, edtEmpresaEndereco_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmpresaEndereco_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11EmpresaNome = cgiGet( edtavEmpresanome_Internalname);
            AssignAttri("", false, "AV11EmpresaNome", AV11EmpresaNome);
      ...
      private void E140C2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tempresa.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A1EmpresaId,12,0))}, new string[] {"Mode","EmpresaId"}) ;
         edtavDelete_Link = formatLink("tempresa.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A1EmpresaId,12,0))}, new string[] {"Mode","EmpresaId"}) ;
      ...
      protected void E110C2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("tempresa.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","EmpresaId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "TEmpresa";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617141689", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtempresa.js", "?202442617141689", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_27_idx;
         edtEmpresaEndereco_Internalname = "EMPRESAENDERECO_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtEmpresaEmail_Internalname = "EMPRESAEMAIL_"+sGXsfl_27_fel_idx;
         edtEmpresaEndereco_Internalname = "EMPRESAENDERECO_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmpresaEmail_Internalname,(string)A3EmpresaEmail,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"mailto:"+A3EmpresaEmail,(string)"",(string)"",(string)"",(string)edtEmpresaEmail_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"email",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Email",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmpresaEndereco_Internalname,(string)A4EmpresaEndereco,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4EmpresaEndereco),(string)"_blank",(string)"",(string)"",(string)edtEmpresaEndereco_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A3EmpresaEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A4EmpresaEndereco));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Work With Empresas";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11EmpresaNome","fld":"vEMPRESANOME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140C2","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtEmpresaNome_Link","ctrl":"EMPRESANOME","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110C2","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11EmpresaNome","fld":"vEMPRESANOME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11EmpresaNome","fld":"vEMPRESANOME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11EmpresaNome","fld":"vEMPRESANOME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11EmpresaNome","fld":"vEMPRESANOME"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11EmpresaNome = "";
         H000C2_A4EmpresaEndereco = new string[] {""} ;
         H000C2_A3EmpresaEmail = new string[] {""} ;
         H000C2_A2EmpresaNome = new string[] {""} ;
         H000C2_A1EmpresaId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtempresa__default(),
            new Object[][] {
                new Object[] {
               H000C2_A4EmpresaEndereco, H000C2_A3EmpresaEmail, H000C2_A2EmpresaNome, H000C2_A1EmpresaId
               }
               , new Object[] {
      ...
      private string edtEmpresaEndereco_Jsonclick ;
      ...
      private string[] H000C2_A4EmpresaEndereco ;
      private string[] H000C2_A3EmpresaEmail ;
      private string[] H000C2_A2EmpresaNome ;
      private long[] H000C2_A1EmpresaId ;
   ...
   public class wwtempresa__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A2EmpresaNome )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EmpresaEndereco], [EmpresaEmail], [EmpresaNome], [EmpresaId]";
         sFromString = " FROM [TEmpresa]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11EmpresaNome)) )
         {
            AddWhere(sWhereString, "([EmpresaNome] like @lV11EmpresaNome)");
         }
         else
         {
            GXv_int1[0] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11EmpresaNome",GXType.NVarChar,30,0) ,
