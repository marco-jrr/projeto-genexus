...
namespace GeneXus.Programs {
   public class wwtusuario : GXDataArea
   {
      public wwtusuario( )
      {
      ...
      public wwtusuario( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11UsuarioNome = GetPar( "UsuarioNome");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11UsuarioNome, AV16IdEmpresa, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwtusuario.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vUSUARIONOME", AV11UsuarioNome);
         /* Send saved values. */
      ...
      {
         return formatLink("wwtusuario.aspx")  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Usuários", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWTUsuario.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWTUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavUsuarionome_Internalname, "Usuario Nome", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsuarionome_Internalname, AV11UsuarioNome, StringUtil.RTrim( context.localUtil.Format( AV11UsuarioNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nome", edtavUsuarionome_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavUsuarionome_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWTUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0I2( )
      {
         ...
         Form.Meta.addItem("description", "Work With Usuários", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Usuarionome Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vUSUARIONOME"), AV11UsuarioNome) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavUsuarionome_Internalname;
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11UsuarioNome = StringUtil.Concat( StringUtil.RTrim( AV11UsuarioNome), "%", "");
            /* Using cursor H000I2 */
            pr_default.execute(0, new Object[] {AV16IdEmpresa, lV11UsuarioNome, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1EmpresaId = H000I2_A1EmpresaId[0];
               A23UsuarioSenha = H000I2_A23UsuarioSenha[0];
               A2EmpresaNome = H000I2_A2EmpresaNome[0];
               A22UsuarioEmail = H000I2_A22UsuarioEmail[0];
               A21UsuarioNome = H000I2_A21UsuarioNome[0];
               A20UsuarioId = H000I2_A20UsuarioId[0];
               A2EmpresaNome = H000I2_A2EmpresaNome[0];
               /* Execute user event: Grid.Load */
               E140I2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11UsuarioNome = StringUtil.Concat( StringUtil.RTrim( AV11UsuarioNome), "%", "");
         /* Using cursor H000I3 */
         pr_default.execute(1, new Object[] {AV16IdEmpresa, lV11UsuarioNome});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11UsuarioNome = GridState.FilterValues("Usuarionome");
            AssignAttri("", false, "AV11UsuarioNome", AV11UsuarioNome);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("UsuarioNome", AV11UsuarioNome);
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtUsuarioId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioId_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         edtUsuarioNome_Enabled = 0;
         AssignProp("", false, edtUsuarioNome_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioNome_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         edtUsuarioEmail_Enabled = 0;
         AssignProp("", false, edtUsuarioEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioEmail_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         ...
         AssignProp("", false, edtUsuarioSenha_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtUsuarioSenha_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11UsuarioNome = cgiGet( edtavUsuarionome_Internalname);
            AssignAttri("", false, "AV11UsuarioNome", AV11UsuarioNome);
      ...
      private void E140I2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A1EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A20UsuarioId,12,0))}, new string[] {"Mode","EmpresaId","UsuarioId"}) ;
         edtavDelete_Link = formatLink("tusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A1EmpresaId,12,0)),UrlEncode(StringUtil.LTrimStr(A20UsuarioId,12,0))}, new string[] {"Mode","EmpresaId","UsuarioId"}) ;
      ...
      protected void E110I2( )
      {
         ...
         returnInSub = false;
         AV19NovoRegistro = "S";
         AV15WebSession.Set("NovoRegistro", AV19NovoRegistro);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "TUsuario";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202442617141799", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtusuario.js", "?202442617141799", false, true);
         }
      ...
      {
         edtUsuarioId_Internalname = "USUARIOID_"+sGXsfl_27_idx;
         edtUsuarioNome_Internalname = "USUARIONOME_"+sGXsfl_27_idx;
         edtUsuarioEmail_Internalname = "USUARIOEMAIL_"+sGXsfl_27_idx;
         edtEmpresaNome_Internalname = "EMPRESANOME_"+sGXsfl_27_idx;
         edtUsuarioSenha_Internalname = "USUARIOSENHA_"+sGXsfl_27_idx;
      ...
      {
         edtUsuarioId_Internalname = "USUARIOID_"+sGXsfl_27_fel_idx;
         edtUsuarioNome_Internalname = "USUARIONOME_"+sGXsfl_27_fel_idx;
         edtUsuarioEmail_Internalname = "USUARIOEMAIL_"+sGXsfl_27_fel_idx;
         edtEmpresaNome_Internalname = "EMPRESANOME_"+sGXsfl_27_fel_idx;
         edtUsuarioSenha_Internalname = "USUARIOSENHA_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUsuarioSenha_Internalname,StringUtil.RTrim( A23UsuarioSenha),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUsuarioSenha_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)-1,(short)0,(short)27,(short)0,(short)0,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavUsuarionome_Internalname = "vUSUARIONOME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtUsuarioNome_Enabled = 0;
         edtUsuarioId_Enabled = 0;
         edtavUsuarionome_Jsonclick = "";
         edtavUsuarionome_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Work With Usuários";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11UsuarioNome","fld":"vUSUARIONOME"},{"av":"AV16IdEmpresa","fld":"vIDEMPRESA","pic":"ZZZZZZZZZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140I2","iparms":[{"av":"A1EmpresaId","fld":"EMPRESAID","pic":"ZZZZZZZZZZZ9"},{"av":"A20UsuarioId","fld":"USUARIOID","pic":"ZZZZZZZZZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110I2","iparms":[]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11UsuarioNome","fld":"vUSUARIONOME"},{"av":"AV16IdEmpresa","fld":"vIDEMPRESA","pic":"ZZZZZZZZZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11UsuarioNome","fld":"vUSUARIONOME"},{"av":"AV16IdEmpresa","fld":"vIDEMPRESA","pic":"ZZZZZZZZZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11UsuarioNome","fld":"vUSUARIONOME"},{"av":"AV16IdEmpresa","fld":"vIDEMPRESA","pic":"ZZZZZZZZZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11UsuarioNome","fld":"vUSUARIONOME"},{"av":"AV16IdEmpresa","fld":"vIDEMPRESA","pic":"ZZZZZZZZZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11UsuarioNome = "";
         H000I2_A1EmpresaId = new long[1] ;
         H000I2_A23UsuarioSenha = new string[] {""} ;
         H000I2_A2EmpresaNome = new string[] {""} ;
         H000I2_A22UsuarioEmail = new string[] {""} ;
         H000I2_A21UsuarioNome = new string[] {""} ;
         H000I2_A20UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtusuario__default(),
            new Object[][] {
                new Object[] {
               H000I2_A1EmpresaId, H000I2_A23UsuarioSenha, H000I2_A2EmpresaNome, H000I2_A22UsuarioEmail, H000I2_A21UsuarioNome, H000I2_A20UsuarioId
               }
               , new Object[] {
      ...
      private int edtavUsuarionome_Enabled ;
      ...
      private string edtavUsuarionome_Internalname ;
      private string edtavUsuarionome_Jsonclick ;
      ...
      private string AV19NovoRegistro ;
      ...
      private long[] H000I2_A1EmpresaId ;
      private string[] H000I2_A23UsuarioSenha ;
      private string[] H000I2_A2EmpresaNome ;
      private string[] H000I2_A22UsuarioEmail ;
      private string[] H000I2_A21UsuarioNome ;
      private long[] H000I2_A20UsuarioId ;
   ...
   public class wwtusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV16IdEmpresa )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[EmpresaId], T1.[UsuarioSenha], T2.[EmpresaNome], T1.[UsuarioEmail], T1.[UsuarioNome], T1.[UsuarioId]";
         sFromString = " FROM ([TUsuario] T1 INNER JOIN [TEmpresa] T2 ON T2.[EmpresaId] = T1.[EmpresaId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[EmpresaId] = @AV16IdEmpresa)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11UsuarioNome)) )
         {
            AddWhere(sWhereString, "(T1.[UsuarioNome] like @lV11UsuarioNome)");
         }
         else
         {
            GXv_int1[1] = 1;
         }
         sOrderString += " ORDER BY T1.[UsuarioNome]";
                                             ...
                                             long AV16IdEmpresa )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([TUsuario] T1 INNER JOIN [TEmpresa] T2 ON T2.[EmpresaId] = T1.[EmpresaId])";
         AddWhere(sWhereString, "(T1.[EmpresaId] = @AV16IdEmpresa)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11UsuarioNome)) )
         {
            AddWhere(sWhereString, "(T1.[UsuarioNome] like @lV11UsuarioNome)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000I2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H000I3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11UsuarioNome",GXType.NVarChar,100,0) ,
